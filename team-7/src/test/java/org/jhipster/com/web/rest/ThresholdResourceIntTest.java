...
public class ThresholdResourceIntTest {
    ...
    private static final Double DEFAULT_M_THRESHOLD_VALUE = 1D;
    private static final Double UPDATED_M_THRESHOLD_VALUE = 2D;
    ...
    public static Threshold createEntity(EntityManager em) {
        Threshold threshold = new Threshold()
                .mThresholdValue(DEFAULT_M_THRESHOLD_VALUE);
        return threshold;
    }
    ...
    public void createThreshold() throws Exception {
        ...
        assertThat(testThreshold.getmThresholdValue()).isEqualTo(DEFAULT_M_THRESHOLD_VALUE);
    ...
    @Test
    @Transactional
    public void checkmThresholdValueIsRequired() throws Exception {
        int databaseSizeBeforeTest = thresholdRepository.findAll().size();
        // set the field null
        threshold.setmThresholdValue(null);
    ...
    public void getAllThresholds() throws Exception {
        ...
        restThresholdMockMvc.perform(get("/api/thresholds?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].mThresholdValue").value(hasItem(DEFAULT_M_THRESHOLD_VALUE.doubleValue())));
    }
    ...
    public void getThreshold() throws Exception {
        ...
        restThresholdMockMvc.perform(get("/api/thresholds/{id}", threshold.getId()))
            ...
            .andExpect(jsonPath("$.mThresholdValue").value(DEFAULT_M_THRESHOLD_VALUE.doubleValue()));
    }
    ...
    public void updateThreshold() throws Exception {
        ...
        updatedThreshold
                .mThresholdValue(UPDATED_M_THRESHOLD_VALUE);
        ...
        Threshold testThreshold = thresholds.get(thresholds.size() - 1);
        assertThat(testThreshold.getmThresholdValue()).isEqualTo(UPDATED_M_THRESHOLD_VALUE);
